...
async function submitBooking() {
  ...
  // "Fire and forget": não trava a tela esperando a resposta.
  if (payload.customer_email) {
    fetch(`${SUPABASE_URL}/functions/v1/send-email-confirmation`, {
      method: "POST",
      headers: {
    ...
    }).catch((e) => console.error("Falha ao disparar e-mail de confirmação:", e));
  }
